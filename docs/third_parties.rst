...
This guide details how to add third-party cogs to Starfire Dashboard and create custom pages on the web Dashboard.

---------------
Getting Started
---------------

Starfire Dashboard allows third-party integrations, enabling cog creators to add custom pages to the Dashboard. Users just need to install and load the cogs that offer this integration on their bot.
